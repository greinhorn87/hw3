...
if (ride.length == 1 || ride.length == 2 || ride.length == 3) {
  passenger1Name = passenger.passengerDetails.first + ' ' + passenger.passengerDetails.last
  passenger1Phone = passenger.passengerDetails.phoneNumber
  passenger1NumberOfPassengers = passenger.passengerDetails.numberOfPassengers
  passenger1PickupAddressLine1 = passenger.pickupLocation.address
  passenger1PickupAddressLine2 = passenger.pickupLocation.city + " " + passenger.pickupLocation.state + " " + passenger.pickupLocation.zip
  passenger1DropoffAddressLine1 = passenger.dropoffLocation.address
  passenger1DropoffAddressLine2 = passenger.dropoffLocation.city + " " + passenger.dropoffLocation.state + ' ' +passenger.dropoffLocation.zip 
} 
else if (ride.length == 2 || ride.length == 3) {
  passenger2Name = passenger.passengerDetails.first + ' ' + passenger.passengerDetails.last
  passenger2Phone = passenger.passengerDetails.phoneNumber
  passenger2NumberOfPassengers = passenger.passengerDetails.numberOfPassengers
  passenger2PickupAddressLine1 = passenger.pickupLocation.address
  passenger2PickupAddressLine2 = passenger.pickupLocation.city + " " + passenger.pickupLocation.state + " " + passenger.pickupLocation.zip
  passenger2DropoffAddressLine1 = passenger.dropoffLocation.address
  passenger2DropoffAddressLine2 = passenger.dropoffLocation.city + " " + passenger.dropoffLocation.state + ' ' +passenger.dropoffLocation.zip 
}
else if (ride.length == 3) {
  passenger3Name = passenger.passengerDetails.first + ' ' + passenger.passengerDetails.last
  passenger3Phone = passenger.passengerDetails.phoneNumber
  passenger3NumberOfPassengers = passenger.passengerDetails.numberOfPassengers
  passenger3PickupAddressLine1 = passenger.pickupLocation.address
  passenger3PickupAddressLine2 = passenger.pickupLocation.city + " " + passenger.pickupLocation.state + " " + passenger.pickupLocation.zip
  passenger3DropoffAddressLine1 = passenger.dropoffLocation.address
  passenger3DropoffAddressLine2 = passenger.dropoffLocation.city + " " + passenger.dropoffLocation.state + ' ' +passenger.dropoffLocation.zip 
}
